...
const waveSrc = readFileSync(join(here, 'assets', 'scripts', 'Battle', 'WaveManager.ts'), 'utf8');
const rewardSrc = readFileSync(join(here, 'assets', 'scripts', 'UI', 'RewardDialog.ts'), 'utf8');
const shopSrc = readFileSync(join(here, 'assets', 'scripts', 'UI', 'ShopDialog.ts'), 'utf8');
const gateSrc = readFileSync(join(here, 'assets', 'scripts', 'Core', 'ModalGate.ts'), 'utf8');
