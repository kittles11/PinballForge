...
| 维度 | 已有 | 缺口 |
|---|---|---|
| 玩法 | 4 球种、3 漏斗、4 钉种、5 敌种、12 卡、5 遗物、50 章×10 关、Meta 死亡补偿 | 动态难度、每日任务、长线目标 |
...
| D1 次留 | Meta 仅 3 条×5 级，约 2 小时毕业 | Meta 扩至 8-10 条，改"科技树"解锁：新球种 / 新钉板版型 / 新流派卡跨局解锁 | 随机+固定奖励混合建立信任 |
