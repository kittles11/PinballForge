...
const ROOT = join(REPO_ROOT, 'assets', 'scripts');
...
// 💥❄️💰：漏斗 EMOJ 标注（2026-09-07 用户拍板的漏斗类型标识，FunnelSlot.ensureTypeLabel 渲染）
...
const texDir = join(REPO_ROOT, 'assets', 'resources', 'textures');
